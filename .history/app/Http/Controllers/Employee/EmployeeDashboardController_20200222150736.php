...
class EmployeeDashboardController extends Controller
{
    ...
    public function updateLead(Request $request, $id) 
    {
        ...
        DB::update('update leads set status = ?, feedback = ?, updated_at=? where id = ?',[$status, $associate_address, $associate_experience, $associate_about, $associate_postalcode, $updated_at,$id]);
