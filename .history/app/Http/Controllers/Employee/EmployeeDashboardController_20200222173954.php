...
class EmployeeDashboardController extends Controller
{
   ...
   public function GeneratePayment(Request $request, $id) 
    ...
    public function GeneratePaymentLink() 
    {
        ...
        $updated_at = new \DateTime();
        $data=array('lead_name'=>$name,  'lead_email'=>$email, 'lead_phone'=>$phone,'status'=>$status, 'created_at'=>$created_at, 'updated_at'=>$updated_at, 'subcategory'=>$subcategory, 'content'=>$content, 'slug'=>$slug);
