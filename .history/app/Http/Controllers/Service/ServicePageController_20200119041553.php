...
class ServicePageController extends Controller
{
    public function ServiceContent(Request $request, $id) 
    {
        ...
        $servicescard = DB::select('select * from host_services where status = "approved"');
        return view('site.service')->with(compact('serviceContent','subcategory', 'services', 'category', 'servicescard'));
    }
}
