...
class ServicesController extends Controller
{
    ...
    public function saveservices(Request $request) 
    {
        ...
        $created_at = new \DateTime();
        $updated_at = new \DateTime();
        $data=array('servicename'=>$servicename,'status'=>$status, 'created_at'=>$created_at, 'updated_at'=>$updated_at, 'category'=>$category, 'subcategory'=>$subcategory, 'content'=>$content);
    ...
    {
        $subcategory = DB::select('select * from services');
        return view('admin.services.services-list',['subcategory'=>$subcategory]);
    }
}
