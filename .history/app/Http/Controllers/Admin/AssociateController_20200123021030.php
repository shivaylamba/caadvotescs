...
class AssociateController extends Controller
{
    ...
    public function postRating(Request $request, $id) 
    {
        ...
        $updated_at = new \DateTime();
        DB::update('update associates set name = ?, associate_rating = ?, updated_at=? where id = ?',[$name, $associate_rating, $updated_at,$updated_at,$id]);
        return redirect('/admin/select/associate')->with('status', 'Service Updated Succesfully');
    }
}
