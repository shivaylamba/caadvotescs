...
class ServicesController extends Controller
{
    ...
    public function saveservices(Request $request) 
    {
        ...
        $created_at = new \DateTime();
        $updated_at = new \DateTime();
        $data=array('serviceimage'=>$serviceimage 'servicename'=>$servicename,'status'=>$status, 'created_at'=>$created_at, 'updated_at'=>$updated_at, 'subcategory'=>$subcategory, 'content'=>$content, 'slug'=>$slug);
