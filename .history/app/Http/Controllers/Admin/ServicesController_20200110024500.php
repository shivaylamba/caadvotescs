...
class ServicesController extends Controller
{
    ...
    public function saveservices(Request $request) 
    {
        ...
        $created_at = new \DateTime();
        $updated_at = new \DateTime();
        $data=array('servicename'=>$subcategoryname,'status'=>$status, 'created_at'=>$created_at, 'updated_at'=>$updated_at, 'category'=>$category, 'subcategory'=>$subcategory, 'content'=>$content);
