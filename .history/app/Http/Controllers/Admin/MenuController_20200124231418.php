...
class MenuController extends Controller
{
    public function menuContent() 
    {
        ...
        $footerpopularservices = DB::select('select * from services where status = "active" and popular="yes" LIMIT 3');
        return view('site.index')->with(compact('category', 'subcategory', 'services', 'popularservices'));
    }
