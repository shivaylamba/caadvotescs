...
class ServicesController extends Controller
{
    ...
    public function savefaq(Request $request) 
    {
        ...
        $created_at = new \DateTime();
        $updated_at = new \DateTime();
        $data=array('servicename'=>$servicename, 'question'=>$question,'answer'=>$answer, 'created_at'=>$created_at, 'updated_at'=>$updated_at);
        DB::table('faqs')->insert($data);
        return redirect('/admin/faq/create')->with('status', 'Service Created Successfully');
    }
}
