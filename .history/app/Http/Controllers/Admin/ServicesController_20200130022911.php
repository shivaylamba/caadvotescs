...
class ServicesController extends Controller
{
    ...
    public function updateservices(Request $request, $id) 
    {
        ...
        $popular = $request->input('popular');
        $updated_at = new \DateTime();
        DB::update('update services set serviceimage = ?, servicename = ?, subcategory=?, content=?, status=?,updated_at=? , popular=? where id = ?',[$name, $servicename, $subcategory, $content, $status,$updated_at,$id]);
