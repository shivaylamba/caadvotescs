...
class ServicesController extends Controller
{
    ...
    public function saveservices(Request $request) 
    {
        ...
        $subcategory = $request->input('status');
        $created_at = new \DateTime();
        $updated_at = new \DateTime();
        $data=array('servicename'=>$subcategoryname,'status'=>$status, 'created_at'=>$created_at, 'updated_at'=>$updated_at, 'updated_at'=>$updated_at, 'updated_at'=>$updated_at);
        DB::table('subcategories')->insert($data);
        return redirect('/create-subcategory')->with('status', 'Sub Category Created Successfully');
    }
