...
class AssociateController extends Controller
{
    ...
    public function AddGovFees() 
    {
        ...
        $data=array('govfees'=>$govfees, 'serviceslug'=>$serviceslug,'status'=>$status, 'created_at'=>$created_at, 'updated_at'=>$updated_at, 'subcategory'=>$subcategory, 'content'=>$content, 'slug'=>$slug);
