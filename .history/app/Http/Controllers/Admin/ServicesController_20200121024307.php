...
class ServicesController extends Controller
{
    ...
    public function updateservices(Request $request, $id) 
    {
        ...
        $status = $request->input('status');
        $updated_at = new \DateTime();
        DB::update('update services set serviceimage = ?, servicename = ?, subcategory=?, content=?, status=?,updated_at=? where id = ?',[$servicename, $subcategory, $content, $status,$updated_at,$id]);
