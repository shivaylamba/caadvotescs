...
class AssociateController extends Controller
{
    ...
    public function postRating(Request $request, $id) 
    {
        ...
        $updated_at = new \DateTime();
        DB::update('update associates set name = ?, associate_rating = ?, updated_at=?, content=?, status=?,updated_at=? where id = ?',[$name, $servicename, $subcategory, $content, $status,$updated_at,$id]);
