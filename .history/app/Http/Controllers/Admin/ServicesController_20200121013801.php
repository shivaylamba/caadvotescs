...
class ServicesController extends Controller
{
    ...
    public function saveservices(Request $request) 
    {
        ...
        request()->image->move(public_path('ServiceImages'), $imageName);
        /*return back()
        ...
        return redirect('/create-services')->with('status', 'Service Created Successfully')->with('success','You have successfully uploaded image.')
        ->with('image',$imageName);;
    }
