...
class DashboardController extends Controller
{
    ...
    public function AddMetaDesc(Request $request) 
    {
        ...
        $created_at = new \DateTime();
        $updated_at = new \DateTime();
        $data=array('metadesc'=>$keywords,'created_at'=>$created_at, 'updated_at'=>$updated_at);
        DB::table('metadescription')->insert($data);
        return redirect('/admin/save/metadescription')->with('status', 'Meta Descripton Added Successfully');
