...
class MenuController extends Controller
{
    ...
    public function menuContent(Request $request) 
    {
        ...
        //->with('menuitem',$menuitem);
            $submenu = SubMenus::all()->whereIn('mainmenu', [ 'Web Development with React', 'Startup', 'PHP Developer']);
    ...
    public function createsubmenu() 
    {
        ...
        return view('admin.create-submenu')->with('submenu',$submenu)->with('menuContent',$menuContent);;
    }
