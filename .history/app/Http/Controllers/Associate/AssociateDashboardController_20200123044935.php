...
class AssociateDashboardController extends Controller
{
    ...
    public function updateprofile(Request $request, $id) 
    {
        ...
        $updated_at = new \DateTime();
        DB::update('update associates set phone = ?, associate_address = ?, associate_experience =?, associate_about=?, associate_postalcode=? , updated_at=? where id = ?',[$phone, $associate_address, $updated_at,$id]);
