...
class AssociateDashboardController extends Controller
{
    ...
    {
        $subcategory = DB::select('select * from associateinvitations where associateEmail = ?',[Auth::user()->email]);
        return view('associate.dashboard.liveservices.subcategory-list',['subcategory'=>$subcategory]);
    }
}
