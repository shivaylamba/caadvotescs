...
class AssociateDashboardController extends Controller
{
    ...
    public function submitService(Request $request)
    {
        ...
        $data=array('requirements'=>$requirements,'status'=>'unapproved', 'created_at'=>$created_at, 'updated_at'=>$updated_at, 'deliverables'=>$deliverables, 'timeline'=>$timeline, 'price'=>$price);
