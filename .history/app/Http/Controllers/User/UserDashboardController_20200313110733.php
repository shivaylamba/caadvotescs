...
class UserDashboardController extends Controller
{
   ...
   public function servicesList() 
    ...
    public function saveupload(Request $request) 
    {
        ...
        return redirect()->back()->with('status', 'Document '.$document_name.' Added to Digital Library Successfully');
    }
    ...
    {
        $library = DB::select('select * from digitallibrary where user_email = ?',[$email])
