...
class UserDashboardController extends Controller
{
   ...
   public function servicesList() 
    ...
    public function compareResult(Request $request)
    {
        ...
        $as_service1 = DB::select('select count(*) from hosted_services WHERE byAssociate = ?',[$as1]);
        $as_service2 = DB::select('select count(*) from hosted_services WHERE byAssociate = ?',[$as2]);
        return view('user.dashboard.associate-result')->with(compact('associate1', 'associate2', 'as_service1', 'as_service2'));
    }
