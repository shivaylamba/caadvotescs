...
class UserDashboardController extends Controller
{
    ...
    public function updateprofile(Request $request, $id) 
    {
        ...
        DB::update('update users set phone = ?, user_address = ?, user_state =?, user_city=?, user_about=? ,user_postalcode=?, updated_at=? where id = ?',[$phone, $associate_address, $associate_experience, $associate_about, $associate_postalcode, $updated_at,$id]);
