...
class UserDashboardController extends Controller
{
   ...
   public function servicesList() 
    ...
    public function saveupload(Request $request) 
    {
        ...
        $data=array('user_email'=>$popular,  'images'=>$name, 'servicename'=>$servicename,'status'=>$status, 'created_at'=>$created_at, 'updated_at'=>$updated_at, 'subcategory'=>$subcategory, 'content'=>$content, 'slug'=>$slug);
