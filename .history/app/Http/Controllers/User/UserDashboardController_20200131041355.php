...
class UserDashboardController extends Controller
{
   ...
   public function servicesList() 
    ...
    public function feedbacksubmit(Request $request) 
    {
        ...
        $updated_at = new \DateTime();
        $data=array('feedback'=>$feedback, 'user'=>$user, 'status'=>'not approved','created_at'=>$created_at, 'updated_at'=>$updated_at);
        DB::table('feedbacks')->insert($data);
        return redirect('/user/feedback/create')->with('status', 'FAQ Added Successfully');
    }
}
