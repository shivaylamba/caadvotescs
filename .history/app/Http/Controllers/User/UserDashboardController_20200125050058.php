...
class UserDashboardController extends Controller
{
    ...
    public function updateprofile(Request $request, $id) 
    {
        ...
        $user_address = $request->input('associate_address');
        $user_state = $request->input('associate_experience');
        $user_city = $request->input('associate_experience');
        $user_about = $request->input('associate_about');
        $user_postalcode = $request->input('associate_postalcode');
