...
// // top three offers screen
//     $(document).ready(function() {
//       $("div.humburger-tab-menu>div.list-group>a").click(function(e) {
//           e.preventDefault();
//           $(this).siblings('a.active').removeClass("active");
//           $(this).addClass("active");
//           var index = $(this).index();
//           $("div.humburger-tab>div.humburger-tab-content").removeClass("active");
//           $("div.humburger-tab>div.humburger-tab-content").eq(index).addClass("active");
//       });
//     });
...
//     $('.scroller_anchor').css('height', 'auto');
//     }
...
//     // **** smooth scroller ****
//     $(function() {
//         $('a[href*="#advantages"]:not([href="#"])').click(pageScrollSmooth);

//         $('a[href*="#process"]:not([href="#"])').click(pageScrollSmooth);

//         $('a[href*="#packageInclusions"]:not([href="#"])').click(pageScrollSmooth);

//         $('a[href*="#documentsRequired"]:not([href="#"])').click(pageScrollSmooth);
...
// our services tab cum accordion start
$(".tab_content1").hide();
  $(".tab_content1:first").show();

  $(".our_services_tab ul.tabs li").click(function () {

    $(".tab_content1").hide();
    var activeTab = $(this).attr("rel");
    $("#" + activeTab).fadeIn();

    $(".our_services_tab ul.tabs li").removeClass("active");
    $(this).addClass("active");
  ...
  $(".tab_drawer_heading1").click(function () {
    ...
    if(!$(this).next().is(':visible')){
      ...
      $(".our_services_tab ul.tabs li").removeClass("active");
      $(".our_services_tab ul.tabs li[rel^='" + d_activeTab + "']").addClass("active");
    }
    else{
      $(".tab_content1").hide();
      $(".tab_drawer_heading1").removeClass("d_active");
  ...
  $( window ).resize(function() {
    if(!$('.tab_content1').is(":visible")){
      $(".tab_content1:first").show();
      $(".tab_drawer_heading1:first").addClass("d_active");
      $(".our_services_tab ul.tabs li:first").addClass("active");
    }
  });

  $('.our_services_tab ul.tabs li').last().addClass("tab_last");


// our services tab cum accordion end


// testimonials owl carousel start
...
// testimonials owl carousel end


// our partners tab start
$(".tab_content").hide();
  $(".tab_content:first").show();

  $(".our_supports_tab ul.tabs li").click(function () {
    ...
    $(".our_supports_tab ul.tabs li").removeClass("active");
    $(this).addClass("active");
  ...
  $(".tab_drawer_heading").click(function () {
    ...
    $(".our_supports_tab ul.tabs li").removeClass("active");
    $(".our_supports_tab ul.tabs li[rel^='" + d_activeTab + "']").addClass("active");
  }  else{
    $(".tab_content").hide();
    $(".tab_drawer_heading").removeClass("d_active");
    $(".our_supports_tab ul.tabs li").removeClass("active");
  ...
  $( window ).resize(function() {
    if(!$('.tab_content').is(":visible")){
      ...
      $(".our_supports_tab ul.tabs li:first").addClass("active");
    }
  });

  $('.our_supports_tab ul.tabs li').last().addClass("tab_last");

// our partners tab end

// our services menu js
$(document).click(function(t){
  $target = $(t.target);
  $secondaryNav = $('.webViewMenuShow1');

  if($target.hasClass('webViewMenuShow1') || $target.hasClass('openServiceMenu')){
    if(!$secondaryNav.is(':visible')){
      $secondaryNav.slideDown('fast');
    }
    else{
