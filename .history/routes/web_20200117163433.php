...
Route::get('/associate_login', 'Associate\AssociateController@show')->name('login')->middleware('guest');
Route::get('/associate_register', 'Associate\AssociateController@show')->name('register')->middleware('guest');