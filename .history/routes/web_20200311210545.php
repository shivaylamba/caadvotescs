...
//Employee 
 ...
 Route::prefix('employee')->group(function() {
   ...
   Route::get('/success-leads', 'Employee\EmployeeDashboardController@Successleads');
   Route::get('/leadPage/{id}', 'Employee\EmployeeDashboardController@leadsPage');
   Route::post('/lead/update/{id}', 'Employee\EmployeeDashboardController@updateLead'); 
   Route::get('/quotation', 'Employee\EmployeeDashboardController@SendQuotation'); 
   Route::post('/sendQuote', 'Employee\EmployeeDashboardController@genQuotation'); 
   Route::get('/test', 'Employee\EmployeeDashboardController@test'); 
   Route::post('/payment', 'Employee\EmployeeDashboardController@eventOrderGen')->name('test.payment');
   Route::post('/payment/status', 'Employee\EmployeeDashboardController@paymentCallback');
}); 

Route::prefix('operation')->group(function() {
   Route::get('/dashboard', 'Employee\EmployeeDashboardController@operationindex')->name('operation.dashboard'); 
   Route::get('/leads', 'Employee\EmployeeDashboardController@opleads');
   Route::get('/leadPage/{id}', 'Employee\EmployeeDashboardController@opleadsPage');
   Route::get('/success-leads', 'Employee\EmployeeDashboardController@opSuccessleads');
   Route::get('/generatePayment/{id}', 'Employee\EmployeeDashboardController@GeneratePayment');
   Route::post('/generatepayment', 'Employee\EmployeeDashboardController@GeneratePaymentLink'); 
   Route::get('/bill', 'Employee\EmployeeDashboardController@GenerateBill');
   Route::post('/sendBill', 'Employee\EmployeeDashboardController@SendBill'); 
   Route::get('/work-status', 'Employee\EmployeeDashboardController@WorkStatus');
 ...
 Route::prefix('user')->group(function() {
    ...
    Route::post('/save-upload/{id}', 'User\UserDashboardController@saveupload'); 
