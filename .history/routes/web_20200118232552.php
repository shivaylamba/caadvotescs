...
//Route::post('/associateregister', 'Associate\AssociateController@register');
 ...
 Route::prefix('associate')->group(function() {
    ...
    Route::get('/register', 'Associate\RegisterController@showRegistrationForm')->name('associate.register');
    Route::post('/login', 'Associate\LoginController@login')->name('associate.login.submit');
    Route::get('/', 'Associate\AssociateController@index')->name('associate.dashboard');
 });