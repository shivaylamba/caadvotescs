...
//Services Page
Route::get('/public/services/{servicename}', 'Service\ServicePageController@ServiceContent');
...
//Associate
 ...
 Route::prefix('associate')->group(function() {
    ...
    Route::post('/liveservice', 'Associate\AssociateDashboardController@saveService');
