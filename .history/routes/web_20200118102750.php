...
Route::namespace('Auth\Login')
      ->group(function() {
       Route::get('associatelogin', 'AssociateLoginController@showLoginForm')->name('login');
    Route::post('associatelogin', 'AssociateLoginController@login')->name('login');
    Route::post('associatelogout', 'AssociateLoginController@logout')->name('logout');
      });
 });