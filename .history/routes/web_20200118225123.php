...
//Route::post('/associateregister', 'Associate\AssociateController@register');
 ...
 Route::prefix('associate')->group(function() {
    Route::get('/associate/login', 'Associate\LoginController@showLoginForm')->name('associate.login');
    Route::post('/associate/login', 'Associate\LoginController@login')->name('associate.login.submit');
    Route::get('/associate', 'Associate\AssociateController@index')->name('associate.dashboard');
 });