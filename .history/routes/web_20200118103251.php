...
Route::namespace('Associate\Login')
      ->group(function() {
       Route::get('login', 'AssociateLoginController@showLoginForm')->name('login');
    Route::post('login', 'AssociateLoginController@login')->name('login');
    Route::post('logout', 'AssociateLoginController@logout')->name('logout');
      });
 });