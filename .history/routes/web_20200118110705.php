...
Route::prefix('associate')
    ->as('associate.')
    ->group(function() {
        Route::get('associate', 'Associate\AssociateController@index')->name('home');
Route::namespace('Associate')
      ->group(function() {
       Route::get('alogin', 'AssociateLoginController@showLoginForm')->name('login');
    Route::post('alogin', 'AssociateLoginController@login')->name('login');
    Route::post('alogout', 'AssociateLoginController@logout')->name('logout');
      });
 });
