...
Route::group(['middleware' => ['auth','admin']], function () {
    ...
    //Associate Controles
    Route::get('/admin/associates/requests', 'Admin\AssociateController@servicesList')->name('admin.associates.request');  
    Route::get('/admin/associates/list', 'Admin\AssociateController@servicesList')->name('admin.associates.list');  
