...
Route::get('/associate_login', 'AssociateController@show')->name('login')->middleware('guest');
Route::get('/associate_register', 'AssociateController@show')->name('register')->middleware('guest');