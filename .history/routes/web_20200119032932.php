...
//Associate
 ...
 Route::prefix('associate')->group(function() {
    ...
    Route::get('/service/host', 'Associate\AssociateDashboardController@hostService')->name('associate.hostService');
    Route::get('/service/host', 'Associate\AssociateDashboardController@submitService')->name('associate.host.service');
