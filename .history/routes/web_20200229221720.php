...
//Employee 
 ...
 Route::prefix('employee')->group(function() {
   ...
   Route::post('/payment', 'Employee\EmployeeDashboardController@eventOrderGen');
   Route::post('/payment/status', 'Employee\EmployeeDashboardController@paymentCallback')->name('test.payment');
}); 
