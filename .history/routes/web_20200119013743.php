...
Route::group(['middleware' => ['auth','admin']], function () {
    ...
    //Associate Controles
    Route::get('/admin/associates/requests', 'Admin\ServicesController@servicesList')->name('admin.associates.request');  
    Route::get('/admin/associates/list', 'Admin\ServicesController@servicesList')->name('admin.associates.lists');  
