...
Route::get('/user/login','Admin\CustomLoginController@LoginPage');
...
//Associate
 ...
 Route::prefix('user')->group(function() {
    ...
    Route::get('/register', 'User\RegisterController@showRegisterForm')->name('associate.register');
    Route::post('/register', 'User\RegisterController@register')->name('associate.register.submit');
    Route::post('/login', 'User\LoginController@login')->name('associate.login.submit');
