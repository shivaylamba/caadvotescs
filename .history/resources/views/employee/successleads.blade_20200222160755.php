                 ...
                 <tbody>
                     @foreach ($leads as $l)
                        <tr>
                            ...
                            <td><b>Sent</b></td>
                            <td>
                                <a href="/employee/generatePayment/{{ $l->id }}" type="button" class="btn btn-slack btn-icon-only rounded-circle">
                                        <span class="btn-inner--icon"><i class="ni ni-send"></i> Generate a New Payment Link</span>
                                </a>
                            </td>
                    </tr>
                    @endforeach
