                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            ...
                            @if($sub->categoryname = $)
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam repellendus nisi quia molestias tempora obcaecati inventore vitae, nesciunt unde, quis consequuntur provident.</p><hr>
                        </div>
                        @endforeach
                    </div>
                </div>
