            ...
            <form role="form" method="POST" action="/user/login">
              @csrf
                 ...
                 <div class="form-group" data-aos="fade-up">
                      <input id="form_name" type="text" name="name" class="form-control" placeholder="Please enter your Email*" required="required" data-error="Email is required.">
                 </div>
                 <div class="form-group" data-aos="fade-up">
                    <input id="form_name" type="email" name="phoneno" class="form-control" placeholder="Please enter your Email*" required="required" data-error="Email is required.">
               </div>
               <div class="form-group" data-aos="fade-up">
