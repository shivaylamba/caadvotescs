...
@include('site.includes.header');
    ...
    <!-- header 1 -->
    <div class="header1 blog-post" style="background: url(https://www.athletadesk.com/wp-content/uploads/2016/08/join-background.jpg) !important; background-size:no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
