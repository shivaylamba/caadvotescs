    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalCenterTitle">Get additional Rs.750/- Off</h5>
        ...
        <div class="modal-body">
          <div class="row">
              <div class="col-md-4">
                  <img src="https://i.pinimg.com/originals/e9/01/77/e90177047a4bda8962a395ffb6f68fd8.jpg" />
              </div>
              <div class="col-md-4">
