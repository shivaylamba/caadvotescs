...
@include('site.includes.header');
    ...
    <!-- header 1 -->
    <div class="header1 blog-post" style="background: url(https://images.unsplash.com/photo-1520531158340-44015069e78e?ixlib=rb-1.2.1&w=1000&q=80) !important; background-size:no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
