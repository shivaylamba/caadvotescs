          ...
          <div class="col-sm-6">
            <form role="form" method="POST" action="/user/register">
              @csrf
                 ...
                 <div class="form-group" data-aos="fade-up">
                    <input id="form_name"  style="color:#fff" type="number" name="phone" class="form-control" placeholder="Please enter your Phone No*" required="required" data-error="Email is required.">
                 </div>
                <div class="form-group" data-aos="fade-up">
