        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="text-container text-left">
                    ...
                    <h2 style="color:#fff !important;">Total Services</h2>
    ...
    <div class="container">
        <div class="row">
            <div class="title padding">
                <h2><span class="red-color">Services</span> is an Example of Box Container</h2>
            ...
            <div class="col-sm-3">
                <div class="box-container text-center" data-aos="fade-up">
                    ...
                    <h3>Free Data Analaytics</h3>
                    <p>Reprehenderit anim officia excepteur Lorem Lorem eiusmod veniam sit velit culpa nonmco tempor.</p>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="box-container text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-sm-3">
                <div class="box-container text-center" data-aos="fade-up" data-aos-delay="200">
                    <i class="fa fa-cloud fa-2x"></i>
                    <h3>Free Data Analaytics</h3>
                    <p>Reprehenderit anim officia excepteur Lorem Lorem eiusmod veniam sit velit culpa nonmco tempor.</p>
                </div>
            ...
            <div class="col-sm-3">
                <div class="box-container text-center" data-aos="fade-up" data-aos-delay="300">
