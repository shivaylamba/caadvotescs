            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav navbar-right" data-in="slideInUp" data-out="slideOutUp">
                    ...
                    <script>
                        ...
                        document.forms[0].action = "/category/<?php echo $menu->categoryname?>" ;
                    }
                    </script>
                    <li class="dropdown megamenu-fw">
                        <a  onclick='openCategory()' href="/category/{{$menu->categoryname}}" class="dropdown-toggle" data-toggle="dropdown">{{$menu->categoryname}}</a>
