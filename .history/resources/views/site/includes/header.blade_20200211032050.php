...
<body>
	                    ...
	                    <li>
	                        <ul class="cd-dropdown-content">
	                            ...
	                            <li class="has-children"> <a href="#" class="webClick" onclick="window.open('/tax-registrations-and-filings','_self');">Tax &amp; Compliance</a> <a href="#" class="mobileViewClick">Tax &amp; Compliance</a>
	                                <ul class="cd-dropdown-icons mc-mobileView1024 fade-out">
	                                    <li class="go-back"><a href="#0"><strong>Menu</strong></a></li>
	                                    <div class="col-md-4 col-12">
	                                        <li>
	                            ...
	                            <li class="has-children"> <a href="#" class="webClick" onclick="window.open('/legal-documentation','_self');">Contracts</a> <a href="#" class="mobileViewClick">Contracts</a>
	                                <ul class="cd-dropdown-icons ld-mobileView fade-out">
	                                    <li class="go-back"><a href="#0"><strong>Menu</strong></a></li>
	                                    <div class="col-md-4 col-12">
	                                        <li>
	...
	<style scoped>
			...
			* {
			...
			#more1, #more2, #more3, #more4, #more5, #more6, #more7, #more8, #more9, #more10, #more11 {
			  color: #2f5bea !important;
			  cursor: pointer;
			}
			#more1:hover, #more2:hover, #more3:hover, #more4:hover, #more5:hover, #more6:hover, #more7:hover, #more8:hover, #more9:hover, #more10:hover, #more11:hover {
			  text-decoration: underline;
			}
			#panel1,#panel2,#panel3,#panel4,#panel5,#panel6,#panel7,#panel8,#panel9,#panel10,#panel11,#mobile-panel1,#mobile-panel2,#mobile-panel3,#mobile-panel4,#mobile-panel5,#mobile-panel6,#mobile-panel7,#mobile-panel8,#mobile-panel9,#mobile-panel10,#mobile-panel11{
			  position: relative;
			  display: none;
			  padding: 0;
			}
			.eac-item a { font-family: 'Roboto' !important; }
			.google { 
			 width: 250px;
			 top: 180px;
			 position: relative;
			...
			.cd-dropdown-content .cd-dropdown-icons .cd-dropdown-item,
			.mobileViewMenuShow .cd-dropdown-content a, .cd-dropdown-content ul a {
			  color: #000 !important;
			}
			...
			.service_page_navbar .has-children > a.webClick.is-active::before,.service_page_navbar .has-children > a.webClick.is-active::after{
			  color:#ffd200!important;
			  display: block;
			}
			...
			.rightmenu li, .rightmenu li > a, .rightmenu li, .rightmenu li > a:hover {
			  margin: 0 2px;
			}
			.rightmenu li, .rightmenu li > a {
			  font-weight: 500;
			...
			.navbar-default .navbar-toggle .icon-bar {
			  ...
			  @media (min-width: 1023px){
			   .service_page_navbar .has-children > a::before, .has-children > a::after, .go-back a::before, .go-back a::after{
			    display: none;
			  }
			  .service_page_navbar .has-children > a:hover::before, .has-children > a:hover::after{
			    display: block;
			  }
			  .cd-dropdown-content > .has-children > ul{
			    margin-left: 0px;
			...
			.navbar-default .service_page_navbar .navbar-toggle:focus, .navbar-default .service_page_navbar .navbar-toggle:hover {
