        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                    <img src="../../images/logo-ca.png" style="width:200px;" class="logo logo-display" alt="">
                    <img src="../../images/logo-ca.png" class="logo logo-scrolled" alt="">
                </a>
                @else 
                <a class="navbar-brand" href="/user/home">
                    Home
                    <img src="../../images/logo-ca.png" class="logo logo-display" alt="">
                    <img src="../../images/logo-ca.png" class="logo logo-scrolled" alt="">
                </a>
                @endif
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                ...
                @else
                    <li class="dropdown">
                    <a href="index.html#" class="submenu dropdown-toggle" data-toggle="dropdown">{{Auth::user()->name}}</a>
                        <ul class="dropdown-menu">
