            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav navbar-right" data-in="slideInUp" data-out="slideOutUp">
                    ...
                    <li class="dropdown megamenu-fw">
                        <a  href="/category/{{$menu->categoryname}}" onclick='show_more_menu()' class="dropdown-toggle" data-toggle="dropdown">{{$menu->categoryname}}</a>
                        
                        <script type='text/javascript'>
                            $(window).resize(function () { function show_more_menu() {
