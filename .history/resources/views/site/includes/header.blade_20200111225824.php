                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-menu col-md-3">
                                        ...
                                        <div class="content">
                                            <ul class="menu-col">
                                                @foreach ($subcategory as $page)
                                                @if ($page->ParentCategory == $menu->categoryname)
                                                <li>
                                                    <a href="/post">{{$page->subcategoryname}}</a>
                                                </li>
                                                @endif
                                                @endforeach
                                            </ul>
                                    ...
                                    <h3><span class="red-color">Great</span> Offer {{$services[0]->servicename}}</h3>
