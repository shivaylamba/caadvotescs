                ...
                <div class="mobileViewMenuShow">
                    <div id="navbar" class="navbar-collapse collapse nopadding">
                        <ul class="cd-dropdown-content" style="height: 360px; background: #fff; padding: 0 12px; position: relative; top: 0px;">
                            ...
                            <li> </li>
                            <li><a href="whatsapp://send?text=Hello CA-ADVOCATE-CS!&amp;phone=+917836943694" class="green-color" style="color: #1bb74e !important;"><i class="fa fa-whatsapp"></i> +91 7200 365 365</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
