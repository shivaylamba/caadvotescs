                            ...
                            <h2>
                             ...
                             <form action="/form/submit">
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text"  name="city" style="color:#fff !important;" class="form-control" id="exampleInputMobile" name="customercity" placeholder="Enter Your City*">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="name" style="color:#fff !important;" class="form-control" id="exampleInputMobile" name="customername" placeholder="Enter Your Full Name*">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
