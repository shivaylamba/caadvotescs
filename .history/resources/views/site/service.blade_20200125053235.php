                        ...
                        <div class="col-md-9">
                            <div class="row" id="products-div" data-service='14'>
                                ...
                                @foreach ($servicescard as $data)
                                    ...
                                    <?php $price = $data->price + ($data->price X (18/100)); ?>
                                    <div class="col-md-4 grid-products" data-price="{{$price}}" data-state='Maharashtra' data-experience='2 to 5 Year' data-rating='4' data-price="{{$data->price}}">
