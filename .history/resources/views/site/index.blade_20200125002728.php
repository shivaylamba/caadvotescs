...
<div tabindex="-1" id="overlay" class="simplemodal-wrap" style="height: 100%; outline: 0px; width: 100%; overflow: visible;">
    <div class="basic-modal-content simplemodal-data" id="popup-data" style="display: block;">
        <div class="Signup_left">
            <a href="">
                <img class="log-selfie" src="https://www.support.ezeestartup.com/productImage/site/startup copy-20191025035414-185-20191107040523-185.jpg"></a></div>
        <div class="Sign_up_right padd-top-14 quick-popup-msg">
            <h4>Get additional Rs.750/- Off</h4>
            <p>Claim your discount now!</p>
            <form id="popup-enquiryfrm">
                <p class="message messagevalidate" style="display:none;">&nbsp;</p>
                <input type="hidden" name="action_type" value="delay-popup-enquiry">
                <input type="hidden" name="heading" value="Get additional Rs.750/- Off">
                <input type="hidden" name="thankyou_msg" value="Thanks for showing up interest. <br>
                Use Coupon code LUCKYSTARTUP to avail Rs.750/- additional discount. 
                <br>
                Hurry! Offer is for limited period only.
                <br>
                Questions? Call us at +91 844 7037 100">
                                <input type="hidden" name="thankyou_mailer" value="Thanks for showing up interest. <br>
                Use Coupon code LUCKYSTARTUP to avail Rs.750/- additional discount. 
                <br>
                Hurry! Offer is for limited period only.
                <br>
                Questions? Call us at +91 844 7037 100">
                <input type="text" name="popup_enquiry_name" placeholder="Enter Name">
                <span class="message" id="msgpopup_enquiry_name" style="display:none;"></span>
                <input type="text" name="popup_enquiry_email" placeholder="Enter Email">
                <span class="message" id="msgpopup_enquiry_email" style="display:none;"></span>
                <input type="text" name="popup_enquiry_mobile" placeholder="Enter Mobile">
                <span class="message" id="msgpopup_enquiry_mobile" style="display:none;"></span>
                <div class="clearfix"></div>
                <button type="button" id="authenticatePopupEnquiry">Yes. I'm Interested</button>
            </form>
        </div>
    </div>
</div>
