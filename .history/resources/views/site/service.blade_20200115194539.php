...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav navbar-left" data-in="slideInUp" data-out="slideOutUp">
                    <li class="dropdown">
                        <a href="blog-post.html#" class="submenu dropdown-toggle" data-toggle="dropdown">Home</a>
                    ...
                    <li class="dropdown megamenu-fw">
                        <a href="blog-post.html#" class="dropdown-toggle" data-toggle="dropdown">Shortcodes
                        </a>
                              ...
                              <div class="col-md-9">
                                <div class="row" id="products-div" data-service='83'>
                                  ...
                                  <div id='product-hide' style="display:none;"></div>
                                                    <div class="col-md-4 grid-products" data-price="2000" data-state='Haryana' data-experience='2 to 5 Year' data-rating='4' data-price="2000">
                                       ...
                                       <div class="on-hover-effect">                                           
                                        ...
                                        <div class="on-mouse-hover-popup  arrow_box">
                                          ...
                                          <ul>
                                                                        ...
                                                                        <li>Appointment/Resignation details of Employees</li>
                                                 
                                          </ul>
                                          <a class="pop-orange-text" href="esi-return-filings/karishma-chauhan-138.html">Read more</a>
                                          <h4>Deliverables</h4>
                                          <ul>
                                                                        <li>Acknowledgment of ESI Return filings</li>
                                                                        <li>Free Consultancy</li>
                                                                      </ul>
                                          <a class="blue-text" href="esi-return-filings/karishma-chauhan-138.html">Read more </a>
                                          <div class="clearfix"></div>
                                          <a href="javascript:void(0)" rel='238' data-action='addtocart' class="addtocart-btn service-addtocart">Add to cart</a>
                                          <a class="wishlist " rel="238" data-action='addtowishlist'  href="login.html"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                        ...
                                        <div class="bottom-wrap"> 						  						  						  
                                          <a href="javascript:void(0)" rel='238' data-action='addtocart' class="buynow-btn service-buynow">Buy Now</a>
                                          <a href="javascript:void(0)" class="compare-button service-compare"  data-associate-service='238'>Add to Compare</a>						 
                                        </div>
                                  </div>
                                   </div>
                                       ...
                                       <div class="on-hover-effect">                                           
                                        ...
                                        <div class="bottom-wrap"> 						  						  						  
                                          ...
                                          <a href="javascript:void(0)" class="compare-button service-compare"  data-associate-service='242'>Add to Compare</a>						 
                                                  ...
                                                  <div class="col-md-4 grid-products" data-price="3000" data-state='Delhi' data-experience='2 to 5 Year' data-rating='4' data-price="3000">
                                    <div class="grid-products-list ">
                                    <div class="NameHighlights">                     
                                      <figure class="card-product"> 
                                       <div class="on-hover-effect">                                           
                                        ...
                                        <div class="on-mouse-hover-popup  arrow_box">
                                          ...
                                          <a class="pop-orange-text" href="esi-return-filings/harish-chaudhary-124.html">Read more</a>
                                          <h4>Deliverables</h4>
                                          <ul>
                                                                        <li>Acknowledgment of ESI Return filings</li>
                                                                        <li>Free Consultancy</li>
                                                                      </ul>
                                          <a class="blue-text" href="esi-return-filings/harish-chaudhary-124.html">Read more </a>
                                          <div class="clearfix"></div>
                                          <a href="javascript:void(0)" rel='398' data-action='addtocart' class="addtocart-btn service-addtocart">Add to cart</a>
                                          <a class="wishlist " rel="398" data-action='addtowishlist'  href="login.html"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                        ...
                                        <div class="bottom-wrap"> 						  						  						  
                                          <a href="javascript:void(0)" rel='398' data-action='addtocart' class="buynow-btn service-buynow">Buy Now</a>
                                          <a href="javascript:void(0)" class="compare-button service-compare"  data-associate-service='398'>Add to Compare</a>						 
                                        </div>
                                  </div>
                                   </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/5a4cc168d7591465c7067b98/default';
        s1.charset='UTF-8';
