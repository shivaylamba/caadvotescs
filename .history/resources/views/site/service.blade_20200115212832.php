                  ...
                  <div class="col-md-3" >
                     ...
                     <div class="side-filter" id='filters'>
                      ...
                      <ul class="sidebar-filter filter-attributes">
                                        <li>
                          <label class="">
                            <input type="checkbox" class="" name='state' id='Haryana' value='Haryana'><span class="material-control-indicator"></span> <span class="material-control-description">Haryana</span> </label>
                        </li>
                                        <li>
