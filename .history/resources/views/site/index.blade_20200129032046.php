...
<section>
    <div class="container">
        <div class="title padding">
            <h2><span class="red-color">Adding </span> tailwinds to our journey</h2>
            <br>
            <div class="line-thin"></div>
            <div class="line-thicken"></div>
        </div>
        <ul class="nav nav-tabs nav-justified">
          <li class="active"><a data-toggle="tab" href="#home">Investors</a></li>
          <li><a data-toggle="tab" href="#menu1">Partners</a></li>
