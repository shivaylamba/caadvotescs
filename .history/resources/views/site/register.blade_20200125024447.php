              ...
              @csrf
                ...
                <div class="form-group" data-aos="fade-up">
                 ...
                 <div class="form-group form_left" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <input id="form_email" type="password" name="password" class="form-control" placeholder="Please Confirm your Password*" required="required" data-error="Valid password is required.">
                    <div class="help-block with-errors"></div>
                 </div>
