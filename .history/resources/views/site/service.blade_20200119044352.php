...
@include('site.includes.header');
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            @if ($serviceContent[0]->servicename == $servicescard[0]->servicename)
            <div class="bootstrap">
                                                ...
                                                <figure class="card-product">
                                                    <div class="on-hover-effect">
                                                        ...
                                                        <figcaption class="info-wrap">
                                                            ...
                                                            <p class="desc">{{$associate[0]->name}}&nbsp;&nbsp;<span class='verified-associate'><i class="fa fa-check-square" aria-hidden="true"></i></span></p>
            ...
            @else
            <section style="margin-top:50px; z-index:20 !important;">
            <br><br><br><br><hr>
            </section>
            @endif
            @endif
    ...
    <section class="faq-section" style="z-index:20 !important;">
        <div class="container">
