              ...
              <div class="col-sm-6">
                  <form action="https://pleurat.com/kanina/contact.php" method="post" id="contact-form">
                     ...
                     <div class="form-group form_left" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <input id="form_email" type="password" name="email" class="form-control" placeholder="Please enter your email *" required="required" data-error="Valid email is required.">
