                        ...
                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                    ...
                                    <div class="col-md-4 float-left">
                                        <div class="detials-box-type-1">
                                            ...
                                            <div class="small-cart-holder">
                                                ...
                                                <?php $gstprice = $servicescard[0]->price + ($servicescard[0]->price*(18/100)); ?>
                                                <h4>Rs. {{$gstprice}}/-</h4>
                                                <span class="professional-fees">Professional Fees Including 18% Gst</span>
                            ...
                            <div class="tab-pane fade" id="nav-Professional" role="tabpanel" aria-labelledby="nav-Professional-tab">
                                <div class="service-tab-panel professional-profile">
                                    ...
                                    <p>Location : <i class="fa fa-map-marker" aria-hidden="true"></i> From <span>{{$associate[0]->associate_state}}</span></p>
