                                    ...
                                    <div class="service-quick-enquiry hidden-xs">
                                        <div class="call-back-holder">
                                            ...
                                            <div class="form-holder" id="call-back-msg">
                                                <form action="/user/quote" id="service-lead-frm" method="POST">
                                                        {{ csrf_field() }}
                                                    ...
                                                    <div class="input-holder">
                                                        <select name="state" onchange="findCity(this)">
                                                    ...
                                                    <div class="input-holder">
                                                        <input type="email" name="city" placeholder="CIty">
                                                        <span><i class="fa fa-location-arrow" aria-hidden="true"></i></span>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <span class="message" id="msgservice_lead_city" style="display:none;">&nbsp;</span>
                                                    <button type="submit" id="authenticateServiceLeadEnquiry">Know More</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="side-filter" id='filters'>
                                <div class="target">
                                    ...
                                    <div class="price-range-box">
                                        <input type="text" id="amount" style="border: 0; color: #f6931f; font-weight: bold;font-size:12px;margin-left:30px;" value="₹4999 - ₹29999" readonly="">
                                        <div id="slider-container" class="ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content">
                                            <div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 0%; width: 67.604%;"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 0%;"></span><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 67.604%;"></span>
                                        </div>
