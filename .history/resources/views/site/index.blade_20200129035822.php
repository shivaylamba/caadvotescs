...
<!-- Tail Wind -->
<section class="marketplace partners style2">
    <div class="container">
        <div class="title padding">
        ...
        <div class="tabbable-panel">
            <div class="tabbable-line">
                ...
                <li><a data-toggle="tab" href="#menu2">Advisors</a></li>
                </ul>
      
                <div class="tab-content">
                <div id="investors" class="tab-pane fade in active">
                    <br><br>
                    <div class="marketplace  style2">
                    <div class="images">
                        <div class="col-sm-2 col-xs-4" data-aos="fade-right">
                            <img src="../../images/png/partner1.png" class="img-responsive" alt="">
                        </div>
                        ...
                        <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                            <ol class="carousel-indicators">
                                <li data-target="#quote-carousel" data-slide-to="0" class="active">
                                    <img class="img-responsive " src="https://s3.amazonaws.com/cdn.designcrowd.com/blog/2017/April/35-Famous-Circle-Logos/19_400.png" alt="">
                                </li>
                                <li data-target="#quote-carousel" data-slide-to="1">
                                    <img class="img-responsive" src="https://develophowto.com/img/favicon.ico" alt="">
                                </li>
                                <li data-target="#quote-carousel" data-slide-to="2">
                                    <img class="img-responsive" src="https://avatars2.githubusercontent.com/u/52008853?s=200&v=4" alt="">
                                </li>
                            </ol>
