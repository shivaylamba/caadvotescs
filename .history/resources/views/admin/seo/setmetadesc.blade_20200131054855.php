        ...
        <div class="col-lg-6">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <!-- Card body -->
              <div class="card-body">
                <form action="/admin/save/metadescription" method="POST" enctype="multipart/form-data">
                    @if (session('status'))
                  ...
                  <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                      <textarea id="froala-editor" name="content">Add your Website Meta description</textarea>
                    </div>
                  </div>
