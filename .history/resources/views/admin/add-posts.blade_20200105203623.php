...
<head>
  ...
  <!-- Argon CSS -->
  <link rel="stylesheet" href="../../assets/css/argon.min.css%3Fv=1.1.0.css" type="text/css">
  <!-- Google Tag Manager -->
  <script>
    (function(w, d, s, l, i) {
      w[l] = w[l] || [];
...
<body>
    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="components.html#navbar-dashboards" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-dashboards">
            ...
            <li class="nav-item">
              <a class="nav-link" href="components.html#navbar-examples" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
            ...
            <li class="nav-item">
              <a class="nav-link" href="components.html#navbar-components" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-components">
              ...
              <div class="collapse" id="navbar-components">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="components.html#navbar-multilevel" class="nav-link" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-multilevel">Multi level</a>
                    <div class="collapse show" id="navbar-multilevel" style="">
                      <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                          <a href="components.html#!" class="nav-link ">Third level menu</a>
                        </li>
                        <li class="nav-item">
                          <a href="components.html#!" class="nav-link ">Just another link</a>
                        </li>
                        <li class="nav-item">
                          <a href="components.html#!" class="nav-link ">One last link</a>
                        </li>
                      </ul>
                    </div>
                  </li>
            ...
            <li class="nav-item">
              <a class="nav-link active" href="components.html#navbar-forms" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-forms">
            ...
            <li class="nav-item">
              <a class="nav-link" href="components.html#navbar-tables" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
            ...
            <li class="nav-item">
              <a class="nav-link" href="components.html#navbar-maps" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-maps">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center ml-md-auto">
            ...
            <li class="nav-item d-sm-none">
              <a class="nav-link" href="components.html#" data-action="search-show" data-target="#navbar-search-main">
                <i class="ni ni-zoom-split-in"></i>
              </a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link" href="components.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right py-0 overflow-hidden">
                ...
                <div class="list-group list-group-flush">
                  <a href="components.html#!" class="list-group-item list-group-item-action">
                ...
                <!-- View all -->
                <a href="components.html#!" class="dropdown-item text-center text-primary font-weight-bold py-3">View all</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link" href="components.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default dropdown-menu-right">
                <div class="row shortcuts px-4">
                  <a href="components.html#!" class="col-4 shortcut-item">
          ...
          <ul class="navbar-nav align-items-center ml-auto ml-md-0">
            <li class="nav-item dropdown">
              <a class="nav-link pr-0" href="components.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="components.html#!" class="dropdown-item">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="components.html#"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="components.html#">Forms</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Form elements</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="components.html#" class="btn btn-sm btn-neutral">New</a>
              <a href="components.html#" class="btn btn-sm btn-neutral">Filters</a>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <ul class="dz-preview dz-preview-multiple list-group list-group-lg list-group-flush">
                    <li class="list-group-item px-0">
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <div class="avatar">
                            <img class="avatar-img rounded" src="https://demos.creative-tim.com/argon-dashboard-pro/pages/forms/..." alt="..." data-dz-thumbnail>
                          </div>
                        </div>
                        <div class="col ml--3">
                        ...
                        <div class="col-auto">
                          <div class="dropdown">
                            <a href="components.html#" class="dropdown-ellipses dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                              <a href="components.html#" class="dropdown-item" data-dz-remove>
                                Remove
                              </a>
                            </div>
                          </div>
  ...
  <!-- Argon JS -->
  <script src="../../assets/js/argon.min.js%3Fv=1.1.0"></script>
