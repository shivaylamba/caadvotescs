              ...
              <div class="card-body">
                <form action="/save-services" method="POST">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="input-group input-group-merge">
                          <div class="input-group-prepend">
                            <span class="input-group-text">Status:</i></span>
                          </div>
                  ...
                  <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        Status: <select class="form-control" name="category" data-toggle="select">
                  ...
                  <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <div data-toggle="quill" data-quill-placeholder="Quill WYSIWYG" name="content"></div>
                    </div>
                  </div>
