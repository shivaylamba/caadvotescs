        ...
        <div class="col-lg-12">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <!-- Card body -->
              <div class="card-body">
                <form action="/admin/govefees/add" method="POST">
                    @if (session('status'))
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="input-group input-group-merge">
                          ...
                          <select class="form-control" placeholder="servicename" name="status">
                              @foreach($service as $s)
                            <option value="{{$service->slug}}">{{$service->servicename}}</option>   
                              @endforeach
                        </select>
                        </div>
                      </div>
