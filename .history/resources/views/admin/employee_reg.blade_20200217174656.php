                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <div class="input-group input-group-merge">
                            ...
                            <input name="emp_pass" class="form-control" placeholder="Employee Password" type="text">
                          </div>
                        </div>
                      </div>
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                        <div class="input-group input-group-merge">
                          <select class="form-control" name="popular" data-toggle="select" type="text">
                            ...
                            <option value="no">INCOME TAX</option>
                            <option value="yes">STARTUP</option>
                            <option value="no">LEGAL</option>
                            <option value="yes">CA</option>
                            <option value="no">CS</option>
                            <option value="no">ADVOCATE</option>
