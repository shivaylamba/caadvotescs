      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/services/approvals' == request()->path() ? 'active' : ''}}{{'/admin/services/total-approved' == request()->path() ? 'active' : ''}}{{'/admin/services/invite' == request()->path() ? 'active' : ''}}" href="#navbar-servicesboard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-servicesboard">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="/admin/services/invite" class="nav-link {{'/admin/services/invite' == request()->path() ? 'active' : ''}}">Invite Professionals</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/gove-fees/add' == request()->path() ? 'active' : ''}}{{'admin/associates/list' == request()->path() ? 'active' : ''}}" href="#navbar-govfees" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
