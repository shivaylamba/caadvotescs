      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/associates/requests' == request()->path() ? 'active' : ''}}{{'/associates/list' == request()->path() ? 'active' : ''}}" href="#navbar-associates" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
