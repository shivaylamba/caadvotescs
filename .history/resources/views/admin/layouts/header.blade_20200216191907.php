            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-category">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/create-category" class="nav-link {{'create-category' == request()->path() ? 'active' : ''}}">Register Employee</a>
                  </li>
                  <li class="nav-item">
                    <a href="/create-subcategory" class="nav-link {{'create-subcategory' == request()->path() ? 'active' : ''}}">Employees Lists</a>
                  </li>
                </ul>
              </div>
            </li>
