      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/employee' == request()->path() ? 'active' : ''}}{{'/admin/employee-List' == request()->path() ? 'active' : ''}}" href="#navbar-employee" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-employee">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/admin/employee" class="nav-link {{'/admin/employee' == request()->path() ? 'active' : ''}}">Register Employee</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/employee-List" class="nav-link {{'/admin/employee-List' == request()->path() ? 'active' : ''}}">Employees Lists</a>
                  </li>
                </ul>
              </div>
            </li>
