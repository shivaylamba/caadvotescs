      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/services/approvals' == request()->path() ? 'active' : ''}}{{'/admin/services/total-approved' == request()->path() ? 'active' : ''}}{{'/admin/services/invite/associate' == request()->path() ? 'active' : ''}}" href="#navbar-servicesboard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-servicesboard">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="/admin/services/invite/associate" class="nav-link {{'/admin/services/invite/associate' == request()->path() ? 'active' : ''}}">Invite Professionals</a>
                  </li>
                </ul>
              </div>
            </li>
