      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/gove-fees/add' == request()->path() ? 'active' : ''}}{{'/admin/gove-fees/list' == request()->path() ? 'active' : ''}}" href="#navbar-rating" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                <i class="ni ni-money-coins text-red"></i>
                <span class="nav-link-text">Give rating</span>
              </a>
              <div class="collapse" id="navbar-rating">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/admin/gove-fees/add" class="nav-link {{'/admin/gove-fees/add' == request()->path() ? 'active' : ''}}">Add</a>
                  </li>
