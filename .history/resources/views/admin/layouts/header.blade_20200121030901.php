            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-servicesboard">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="/admin/services/total-approved" class="nav-link {{'services-list' == request()->path() ? 'active' : ''}}">Total Listed</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/services/approvals" class="nav-link {{'services-list' == request()->path() ? 'active' : ''}}">Invite Professionals</a>
                  </li>
                </ul>
              </div>
            </li>
