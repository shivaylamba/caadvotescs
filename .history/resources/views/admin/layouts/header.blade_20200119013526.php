          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-associates">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/admin/associate/requests" class="nav-link {{'create-services' == request()->path() ? 'active' : ''}}">Associates Requests</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/associate/list" class="nav-link {{'services-list' == request()->path() ? 'active' : ''}}">Total Associates</a>
                  </li>
                </ul>
              </div>
            </li>
