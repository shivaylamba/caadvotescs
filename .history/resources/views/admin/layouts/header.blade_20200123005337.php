      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/faq/create' == request()->path() ? 'active' : ''}}{{'/admin/gove-fees/list' == request()->path() ? 'active' : ''}}" href="#navbar-faq" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-faq">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="/admin/faq/list" class="nav-link {{'admin/associates/list' == request()->path() ? 'active' : ''}}">List</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/gove-fees/add' == request()->path() ? 'active' : ''}}{{'/admin/gove-fees/list' == request()->path() ? 'active' : ''}}" href="#navbar-rating" role="button" aria-expanded="false" aria-controls="navbar-tables">
