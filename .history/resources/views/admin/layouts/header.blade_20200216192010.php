      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'create-category' == request()->path() ? 'active' : ''}}{{'create-subcategory' == request()->path() ? 'active' : ''}}{{'category-list' == request()->path() ? 'active' : ''}}{{'subcategory-list' == request()->path() ? 'active' : ''}}" href="#navbar-employee" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-employee">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/admin/employee" class="nav-link {{'create-category' == request()->path() ? 'active' : ''}}">Register Employee</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/employee-List" class="nav-link {{'create-subcategory' == request()->path() ? 'active' : ''}}">Employees Lists</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/seo/description' == request()->path() ? 'active' : ''}}{{'/admin/seo/keywords' == request()->path() ? 'active' : ''}}" href="#navbar-seo" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                <i class="ni ni-books text-black"></i>
                <span class="nav-link-text">SEO</span>
              </a>
              <div class="collapse" id="navbar-seo">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/admin/seo/description" class="nav-link {{'/admin/seo/description' == request()->path() ? 'active' : ''}}">Set Meta Description</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/seo/keywords" class="nav-link {{'/admin/seo/keywords' == request()->path() ? 'active' : ''}}">Set Meta Keywords</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link {{'/admin/leads' == request()->path() ? 'active' : ''}}{{'/admin/leads' == request()->path() ? 'active' : ''}}" href="#navbar-leads" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                <i class="ni ni-chart-pie-35 text-blue"></i>
                <span class="nav-link-text">Lead Management System</span>
              </a>
              <div class="collapse" id="navbar-leads">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/admin/leads" class="nav-link {{'/admin/leads' == request()->path() ? 'active' : ''}}">Leads</a>
                  </li>
                </ul>
              </div>
            </li>
