          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-servicesboard">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/admin/services/approvals" class="nav-link {{'/admin/services/approvals' == request()->path() ? 'active' : ''}}">Set Meta Tags</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/services/total-approved" class="nav-link {{'/admin/services/total-approved' == request()->path() ? 'active' : ''}}">Set Meta Description</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/associates/invite" class="nav-link {{'/admin/associates/invite' == request()->path() ? 'active' : ''}}">Set Meta Keywords</a>
                  </li>
                </ul>
              </div>
            </li>
