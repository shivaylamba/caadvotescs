      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/leads' == request()->path() ? 'active' : ''}}{{'/admin/leads' == request()->path() ? 'active' : ''}}" href="#navbar-seo" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                <i class="ni ni-books text-black"></i>
