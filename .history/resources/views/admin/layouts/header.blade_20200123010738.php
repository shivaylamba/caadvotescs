      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/select/associate' == request()->path() ? 'active' : ''}}{{'/admin/gove-fees/list' == request()->path() ? 'active' : ''}}" href="#navbar-rating" role="button" aria-expanded="false" aria-controls="navbar-tables">
