      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/services/approvals' == request()->path() ? 'active' : ''}}{{'services-list' == request()->path() ? 'active' : ''}}" href="#navbar-servicesboard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
