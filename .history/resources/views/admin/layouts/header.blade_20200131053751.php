      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/admin/seo/tags' == request()->path() ? 'active' : ''}}{{'/admin/seo/description' == request()->path() ? 'active' : ''}}{{'/admin/seo/keywords' == request()->path() ? 'active' : ''}}" href="#navbar-servicesboard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                <i class="ni ni-books text-yellow"></i>
              ...
              <div class="collapse" id="navbar-seo">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/admin/seo/tags" class="nav-link {{'/admin/seo/tags' == request()->path() ? 'active' : ''}}">Set Meta Tags</a>
                  </li>
                  <li class="nav-item">
