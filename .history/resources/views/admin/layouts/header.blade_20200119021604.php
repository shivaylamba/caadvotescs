      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/associates/requests' == request()->path() ? 'active' : ''}}{{'/associates/list' == request()->path() ? 'active' : ''}}" href="#navbar-associates" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-associates">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="{{route('admin.associates.request')}}" class="nav-link {{'/associates/requests' == request()->path() ? 'active' : ''}}">Associates Requests</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/associates/list" class="nav-link {{'/associates/list' == request()->path() ? 'active' : ''}}">Total Associates</a>
                  </li>
                </ul>
              </div>
            </li>
