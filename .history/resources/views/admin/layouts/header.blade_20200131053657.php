            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-servicesboard">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="/admin/seo/description" class="nav-link {{'/admin/services/total-approved' == request()->path() ? 'active' : ''}}">Set Meta Description</a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/seo/keywords" class="nav-link {{'/admin/associates/invite' == request()->path() ? 'active' : ''}}">Set Meta Keywords</a>
                  </li>
                </ul>
              </div>
            </li>
