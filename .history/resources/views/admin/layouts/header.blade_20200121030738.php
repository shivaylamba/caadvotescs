      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'create-services' == request()->path() ? 'active' : ''}}{{'services-list' == request()->path() ? 'active' : ''}}" href="#navbar-servicesboard" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                <i class="ni ni-archive-2 text-yellow"></i>
                <span class="nav-link-text">Listed Services Controller</span>
              </a>
              <div class="collapse" id="navbar-servicesboard">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/create-services" class="nav-link {{'create-services' == request()->path() ? 'active' : ''}}">Approvals</a>
                  </li>
                  <li class="nav-item">
                    <a href="/services-list" class="nav-link {{'services-list' == request()->path() ? 'active' : ''}}">Total Listed</a>
                  </li>
                  <li class="nav-item">
                    <a href="/services-list" class="nav-link {{'services-list' == request()->path() ? 'active' : ''}}">Invite Professionals</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-govfees">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="{{route('admin.associates.request')}}" class="nav-link {{'admin/associates/requests' == request()->path() ? 'active' : ''}}">Add</a>
                  </li>
                  <li class="nav-item">
