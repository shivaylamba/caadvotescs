            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-tables">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/create-category" class="nav-link {{['create-category','category-list', 'create-subcategory', 'subcategory-list'] == request()->path() ? 'active' : ''}}">Create Category</a>
                  </li>
                  <li class="nav-item">
                    <a href="/create-subcategory" class="nav-link {{['create-category','category-list', 'create-subcategory', 'subcategory-list'] == request()->path() ? 'active' : ''}}">Create SubCategory</a>
                  </li>
                  <li class="nav-item">
                    <a href="/category-list" class="nav-link {{['create-category','category-list', 'create-subcategory', 'subcategory-list'] == request()->path() ? 'active' : ''}}">Category List</a>
                  </li>
                  <li class="nav-item">
