          ...
          <div class="col-sm-6">
            <form role="form" method="POST" action="/user/register">
              @csrf
                ...
                <div class="form-group" data-aos="fade-up">
                    <select id="form_name" type="text" name="associate_profession" class="form-control" placeholder="Select Profession*" required="required" data-error="Email is required.">
                ...
                <div class="form-group" data-aos="fade-up">
                    <select id="form_name" type="text" name="associate_state" class="form-control" placeholder="Select State*" required="required" data-error="Email is required.">
                ...
                <div class="form-group" data-aos="fade-up">
                    <input id="form_name" type="email" name="email" class="form-control" placeholder="Please Enter Your City*" required="required" data-error="City is required.">
                </div>
