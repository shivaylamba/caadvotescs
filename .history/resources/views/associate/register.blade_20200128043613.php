          ...
          <div class="col-sm-6">
            <form role="form" method="POST" action="/user/register">
              @csrf
                ...
                <div class="form-group" data-aos="fade-up">
                    <select id="form_name" type="email" name="associate_profession" class="form-control" placeholder="Select Profession*" required="required" data-error="Email is required.">
