          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <input name="byAssociate" class="form-control" placeholder="{{ Auth::user()->email }}" value="{{ Auth::user()->email }}" type="text">
                  <div class="row">
                    <div class="card">
                        <!-- Card header -->
                        <div class="card-header">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                        <select class="form-control" name="servicename" data-toggle="select">
                          @foreach ($services as $sservicesData)
                          <option value="{{$servicesData->subcategoryname}}">{{ucfirst($subcategory->subcategoryname)}}</option>
                            @endforeach
                        </select>
                    </div>
                  </div>
