      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'admin/associates/requests' == request()->path() ? 'active' : ''}}{{'admin/associates/list' == request()->path() ? 'active' : ''}}" href="#navbar-invitations" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                <i class="ni ni-money-coins text-red"></i>
              ...
              <div class="collapse" id="navbar-invitations">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="{{route('admin.associates.request')}}" class="nav-link {{'admin/associates/requests' == request()->path() ? 'active' : ''}}">New Invitations Check</a>
                  </li>
                </ul>
              </div>
            </li>
