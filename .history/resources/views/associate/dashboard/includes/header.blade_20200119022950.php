      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'associate/service/host' == request()->path() ? 'active' : ''}}{{'services-list' == request()->path() ? 'active' : ''}}" href="#navbar-services" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-services">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/associate/service/host" class="nav-link {{'associate/service/host' == request()->path() ? 'active' : ''}}">Host</a>
                  </li>
                  <li class="nav-item">
                    <a href="/associate/service/list" class="nav-link {{'services-list' == request()->path() ? 'active' : ''}}">Currently Hosted Categories</a>
                  </li>
                </ul>
              </div>
            </li>
