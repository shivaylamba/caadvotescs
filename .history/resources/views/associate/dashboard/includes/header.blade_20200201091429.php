      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/associate/profile' == request()->path() ? 'active' : ''}}" href="#navbar-profile" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-profile">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="/associate/profile" class="nav-link {{'/associate/invitations' == request()->path() ? 'active' : ''}}">Skills</a>
                  </li>
                </ul>
              </div>
            </li>
