      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/associate/govefees' == request()->path() ? 'active' : ''}}" href="#navbar-govfees" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div class="collapse" id="navbar-govfees">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/associate/govefees" class="nav-link {{'/associate/govefees' == request()->path() ? 'active' : ''}}">List</a>
                  </li>
                </ul>
              </div>
            </li>
