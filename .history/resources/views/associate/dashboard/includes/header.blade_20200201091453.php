      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/associate/profile' == request()->path() ? 'active' : ''}}{{'/associate/skills' == request()->path() ? 'active' : ''}}" href="#navbar-profile" role="button" aria-expanded="false" aria-controls="navbar-tables">
