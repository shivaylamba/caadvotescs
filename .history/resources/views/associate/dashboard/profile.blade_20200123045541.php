                   ...
                   <div class="row">
                     ...
                     <div class="col-lg-4">
                       <div class="form-group">
                         ...
                         <input type="number" id="input-postal-code" class="form-control" placeholder="{{$associates[0]->associate_postalcode}}" value="{{$associates[0]->associate_state}}" name="associate_postalcode">
                       </div>
                     </div>
                   </div>
                   <div class="row">
