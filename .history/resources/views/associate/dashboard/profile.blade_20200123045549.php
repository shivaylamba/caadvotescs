       ...
       <div class="row">
           ...
           <div class="card card-profile">
             ...
             <div class="card-body pt-0">
               ...
               <div class="text-center">
                 <h5 class="h3">
                    {{ $associates[0]->name }} <span class="font-weight-light"></span>
                 </h5>
                 <div class="h5 font-weight-300">
                   <i class="ni location_pin mr-2"></i>{{$associates[0]->associate_city}},{{$associates[0]->associate_state}}
                 </div>
               </div>
             </div>
           </div>
         ...
         <div class="col-xl-8 order-xl-1">
           ...
           <div class="card">
             ...
             <div class="card-body">
             <form action="/associate/update-profile/{{ $associates[0]->id }}" method="POST">
                   {{ csrf_field() }}
                   @if (session('status'))
                   ...
                   <div class="row">
                     <div class="col-lg-6">
                       <div class="form-group">
                         ...
                         <input type="text" id="input-first-name" class="form-control" placeholder="First name" name="phone" value="{{ $associates[0]->phone }}">
                       </div>
                     </div>
                     <div class="col-lg-6">
                       <div class="form-group">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input id="input-address" class="form-control" placeholder="{{ $associates[0]->associate_address }}"  name="associate_address" value="{{ $associates[0]->associate_address }}" type="text">
                       </div>
                     </div>
                   </div>
                   <div class="row">
                     ...
                     <div class="col-lg-4">
                       <div class="form-group">
                         ...
                         <input type="number" id="input-postal-code" class="form-control" placeholder="{{$associates[0]->associate_postalcode}}" value="{{$associates[0]->associate_postalcode}}" name="associate_postalcode">
                       </div>
                     </div>
                   </div>
                   <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-country" class="form-control"  placeholder="India" value="India" disabled>
                      </div>
                    </div>
                  </div>
                 </div>
                 ...
                 <div class="pl-lg-4">
                   <div class="form-group">
                     ...
                     <textarea rows="4" class="form-control" name="associate_about" placeholder="A few words about you ...">A beautiful premium dashboard for Bootstrap 4.</textarea>
                   </div>
                 </div>
