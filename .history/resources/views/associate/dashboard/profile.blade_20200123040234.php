     ...
     <div class="header pb-6 d-flex align-items-center" style="min-height: 500px; background-image: url(../../assets/img/theme/profile-cover.jpg); background-size: cover; background-position: center top;">
       ...
       <div class="container-fluid d-flex align-items-center">
         <div class="row">
           ...
           <h1 class="display-2 text-white">Profile of {{ $associates->name }}</h1>
             <p class="text-white mt-0 mb-5">This is user profile page for user {{ $associates->name }}. You can see the progress made by the user. user work and manage user account</p>
           </div>
         </div>
       </div>
     </div>
       ...
       <div class="row">
         ...
         <div class="col-xl-8 order-xl-1">
           ...
           <div class="card">
             ...
             <div class="card-body">
             <form action="/user-profile-update/{{ $users->id }}" method="POST">
                   {{ csrf_field() }}
                   {{ method_field('PUT') }}
                   ...
                   <div class="row">
                     <div class="col-lg-6">
                       <div class="form-group">
                         ...
                         <input type="text" id="input-username" class="form-control" placeholder="Username" value="{{ $associates->name }}" disabled>
                       </div>
                     </div>
                     <div class="col-lg-6">
                       <div class="form-group">
                         <label class="form-control-label" for="input-email">Email address</label>
                         <input type="email" id="input-email" class="form-control" placeholder="{{ $associates->email }}" disabled>
                       </div>
                     </div>
                   </div>
                   <div class="row">
                     <div class="col-lg-6">
                       <div class="form-group">
                         ...
                         <input type="text" id="input-first-name" class="form-control" placeholder="First name" value="{{ $associates->phone }}" disabled>
                       </div>
                     </div>
                     <div class="col-lg-6">
                       <div class="form-group">
