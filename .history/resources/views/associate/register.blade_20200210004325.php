          ...
          <div class="col-sm-6">
            <form method="POST" action="{{ route('associate.register.submit') }}">
                @csrf
                 ...
                 <div class="form-group" data-aos="fade-up">
                    <input id="form_name"  style="color:#fff" type="phone" name="phone" class="form-control" placeholder="Please enter your Phone No*" required="required" data-error="Email is required.">
                 </div>
                <div class="form-group" data-aos="fade-up">
