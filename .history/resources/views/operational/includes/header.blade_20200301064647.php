      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{'/operation/work-status' == request()->path() ? 'active' : ''}}{{'/operation/success-leads' == request()->path() ? 'active' : ''}}{{'/operation/bill' == request()->path() ? 'active' : ''}}" href="#navbar-work" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
                <i class="ni ni-app text-purple"></i>
                <span class="nav-link-text">Work Status</span>
              </a>
              <div class="collapse" id="navbar-work">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
