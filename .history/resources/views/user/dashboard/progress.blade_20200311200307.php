...
<div class="main-content" id="panel">
    <!-- Topnav -->
    @include('user.dashboard.customtopmenu')
    <!-- Header -->
    <!-- Header -->

    @include('user.dashboard.customtopBar')
    <!-- Page content -->
        ...
        <div class="col-lg-6">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <h3 class="mb-0">Lead Progress Details for Service: {{$leads[0]->service}} Ticket No: {{$leads[0]->cust_id}}</h3>
              </div>
              <!-- Card body -->
              <div class="card-body">
