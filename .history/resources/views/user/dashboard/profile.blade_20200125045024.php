                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input id="input-address" class="form-control" placeholder="{{ $user[0]->user_address }}"  name="associate_address" value="{{ $user[0]->user_address }}" type="text">
                       </div>
                     </div>
                   </div>
                   <div class="row">
                     <div class="col-lg-4">
                       <div class="form-group">
                         ...
                         <input type="text" id="input-city" class="form-control" name="associate_city" placeholder="{{ $user[0]->user_city }}" value="{{ $user[0]->user_city }}">
                       </div>
                     </div>
                     <div class="col-lg-4">
                       <div class="form-group">
                         <label class="form-control-label" for="input-country">State</label>
                         <input type="text" id="input-country" class="form-control" name="associate_state" placeholder="{{ $user[0]->user_state }}" value="{{ $user[0]->user_state }}">
                       </div>
                     </div>
                     <div class="col-lg-4">
                       <div class="form-group">
                         <label class="form-control-label" for="input-country">Postal code</label>
                         <input type="number" id="input-postal-code" class="form-control" placeholder="{{$user[0]->user_postalcode}}" value="{{$user[0]->user_postalcode}}" name="associate_postalcode">
                       </div>
                     </div>
                   </div>
                 </div>
