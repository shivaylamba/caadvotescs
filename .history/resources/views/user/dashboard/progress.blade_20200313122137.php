          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              ...
              <div class="row"> 
                &nbsp;
                <div class="col-md-10">
                  <p> &nbsp;<span style="color:brown; font-weight:bold;">Employee:</span> <span style="font-style:italic;">Hello Customer How can i Help You?</span></p>
                </div>
              ...
              <div class="row">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                  <p> <span style="font-style:italic;">I Need help Regarding My Service Quotation*</p>
                </div>
              </div>
