      ...
      <div class="row">
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0">Please upload the Required Documents <input  type="text" name="service_name" class="form-control" value="{{$leads[0]->service}}" disabled></h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
                <ul class="list-group list-group-flush list my--3">
                  <li class="list-group-item px-0">
                    <div class="row align-items-center">
                      ...
                      <div class="col-auto">
                        <input  class="btn btn-sm btn-primary" type="text" name="Cust_ID" class="form-control" value="{{$leads[0]->cust_id}}" style="display:none;">
                        <input  class="btn btn-sm btn-primary" type="text" name="id" class="form-control" value="{{$leads[0]->id}}" style="display:none;">
