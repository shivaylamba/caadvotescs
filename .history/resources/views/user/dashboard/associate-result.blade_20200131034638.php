        ...
        <div class="col-lg-4">
            <div class="card card-profile">
                ...
                <div class="card-body pt-0">
                    ...
                    <h5>Rating: @for($i = 0; $i<$associate1[0]->associate_rating; $i++)
                        <i class="fa fa-sm fa-star"></i>
                        @endfor
                        {{$associate1[0]->associate_rating}}/5
                    </h5>
        ...
        <div class="col-lg-4">
            <div class="card card-profile">
                ...
                <div class="card-body pt-0">
                    ...
                    <h5>Rating: @for($i = 0; $i<$associate2[0]->associate_rating; $i++)
                        <i class="fa fa-sm fa-star" style="color:yellow"></i>
                        @endfor
                        {{$associate2[0]->associate_rating}}/5
                    </h5>
