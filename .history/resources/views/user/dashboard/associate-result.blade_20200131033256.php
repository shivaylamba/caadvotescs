        ...
        <div class="col-lg-4">
            <div class="card card-profile">
                ...
                <div class="card-body pt-0">
                    ...
                    <h5>Total Services Participated In: <span style="color:aquamarine">{{$s1}}</span></h5>
                    <h5>Rating:<span style="color:aquamarine"></span></h5>
                    <h5>Category: <span style="color:aquamarine">{{$associate1[0]->associate_category}}</span></h5>
                    <h5>Profession: <span style="color:aquamarine">{{$associate1[0]->associate_profession}}</span></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card card-profile">
                ...
                <div class="card-body pt-0">
                    ...
                    <h5>Total Services Participated In: <span style="color:aquamarine">{{$s2}}</span></h5>
                    <h5>Rating:</h5>
                    <h5>Category: <span style="color:aquamarine">{{$associate2[0]->associate_category}}</span></h5>
                    <h5>Profession: <span style="color:aquamarine">{{$associate2[0]->associate_profession}}</span></h5>
                </div>
            </div>
        </div>
        <div class="col-lg-2">
