      ...
      <div class="row">
              ...
              <form action="/employee/lead/update/{{$leads[0]->id}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                     ...
                     <li>PAYMENT STATUS: <span style="color:blue;">Pending</span></li>
                    </div>
                  </div>
                </form>
              </div>
        ...
        <div class="col-lg-4">
          <div class="card">
            ...
            <!-- Card body -->
            <div class="card-body p-0" style="overflow-y:auto !important; overflow-x:hidden; height: 17em;">
              <!-- List group -->
                <div class="row"> 
                  &nbsp;
                  <div class="col-md-10">
                    &nbsp;<span style="color:brown; font-weight:bold; font-style:italic;">Amit(Sales):</span> <span style="font-style:italic;">Hello Customer, My Name is Amit i am the Employee Assigned to help you. If you need help with anything just Text me back i will assist you.</span><br><br>
                  </div>
                  <div class="col-md-2"></div>
                </div>
                <div class="row">
                  <div class="col-sm-1">Aakash</div>
                  <div class="col-sm-1"><span class="avatar avatar-sm rounded-circle"><img alt="Image placeholder" src="../../assets/img/theme/team-4.jpg"></span></div>
                  <div class="col-sm-10">
                    <span style="font-style:italic;">I Need help Regarding My Service Quotation*</span><br><br>
                  </div>
                </div>
                <div class="row"> 
                  &nbsp;
                  <div class="col-md-10">
                    &nbsp;<span style="color:brown; font-weight:bold; font-style:italic;">Amit(Sales):</span> <span style="font-style:italic;">Hello Customer, My Name is Amit i am the Employee Assigned to help you. If you need help with anything just Text me back i will assist you.</span>
                  </div>
                  <div class="col-md-2"></div>
                </div>
              </div>
                ...
                <div class="media-body">
                  <form>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Type Your Message and hit Enter to Send">
                    </div>
                  </form>
                </div>
              </div>
