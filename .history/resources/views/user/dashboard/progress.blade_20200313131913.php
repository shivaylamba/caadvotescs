            ...
            <div class="card-body p-0" style="overflow-y:auto !important; overflow-x:hidden; height: 17em;">
              <!-- List group -->
                ...
                <div class="row">
                  <div class="col-md-2"></div>
                  <div class="col-md-10">
                    <span style="font-style:italic;">I Need help Regarding My Service Quotation*</span><span class="avatar avatar-sm rounded-circle"><img alt="Image placeholder" src="../../assets/img/theme/team-4.jpg"></span><br>
                  </div>
                </div>
                <div class="row"> 
                  &nbsp;
