        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="text-container text-left">
                    ...
                    <a href="blog-post.html#">Employee Login</a>
                    <h2 style="color:#fff !important;">Login to Dashboard</h2>
            ...
            @endif
              @csrf
                 ...
                 <div class="form-group" data-aos="fade-up">
                      <input  style="color:#fff" id="form_name" type="email" name="emp_email" class="form-control" placeholder="Please enter your Email*" required="required" data-error="Email is required.">
                 </div>
