     ...
     <div class="header pb-6 d-flex align-items-center" style="min-height: 500px; background-image: url(https://www.timsonlaw.com/wp-content/uploads/sites/7004/2018/03/banner-min.jpg); background-size: cover; background-position: center top;">
       ...
       <div class="container-fluid d-flex align-items-center">
         <div class="row">
           ...
           <h1 class="display-2 text-white">Profile of {{ ucfirst($user[0]->name) }}</h1>
       ...
       <div class="row">
         ...
         <div class="col-xl-8 order-xl-1">
           ...
           <div class="card">
             ...
             <div class="card-body">
             <form action="/user/update-profile/{{ $user[0]->id }}" method="POST">
                   {{ csrf_field() }}
                   @if (session('status'))
                   ...
                   <div class="row">
                     <div class="col-lg-6">
                       <div class="form-group">
                         ...
                         <input type="text" id="input-username" class="form-control" placeholder="Username" value="{{ ucfirst($user[0]->name) }}" disabled>
                       </div>
                     </div>
                     <div class="col-lg-6">
                       <div class="form-group">
