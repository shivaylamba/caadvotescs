        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="text-container text-left">
                    ...
                    <h2 style="color:#fff !important;">Quotation Sent Succesfully</h2>
      ...
      <div class="row">
          <div class="col-sm-12">
              <div class="title text-left">
                  <h2>Thank you for submitting the request at<span class="red-color"> caadvotescs.com</span></h2>
                  <p>Your Request have Succesfully sent to Admin's, We will contact you as soon as Possible in order to help you out.</p>
                  <p>Meanwhile you can check the email containing all the details and the Quotation</p>
                  <br>
